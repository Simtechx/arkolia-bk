...
export const surahs: Surah[] = [
  ...
  { id: 91, name: "Ash-Shams", nameArabic: "الشمس", verses: 15, type: "Makkan", length: "Short", juz: 30, themes: ["Tawheed", "Oaths"], usage: ["Daily"], openingStyle: "Oaths", sajdah: false },
  { id: 92, name: "Al-Layl", nameArabic: "الليل", verses: 21, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Oaths"], usage: ["Night"], openingStyle: "Oaths", sajdah: false },
  { id: 93, name: "Ad-Duha", nameArabic: "الضحى", verses: 11, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Oaths"], usage: ["Morning"], openingStyle: "Oaths", sajdah: false },
  { id: 94, name: "Ash-Sharh", nameArabic: "الشرح", verses: 8, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Comfort"], usage: ["Daily"], openingStyle: "Commands", sajdah: false },
  ...
  { id: 96, name: "Al-Alaq", nameArabic: "العلق", verses: 19, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Knowledge"], usage: ["Daily"], openingStyle: "Commands", sajdah: false },
  { id: 97, name: "Al-Qadr", nameArabic: "القدر", verses: 5, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Ramadan"], usage: ["Ramadan"], openingStyle: "Commands", sajdah: false },
  ...
  { id: 100, name: "Al-Adiyat", nameArabic: "العاديات", verses: 11, type: "Makkan", length: "Short", juz: 30, themes: ["Oaths", "Tawheed"], usage: ["Daily"], openingStyle: "Oaths", sajdah: false },
  ...
  { id: 103, name: "Al-Asr", nameArabic: "العصر", verses: 3, type: "Makkan", length: "Short", juz: 30, themes: ["Oaths", "Commands"], usage: ["Daily"], openingStyle: "Oaths", sajdah: false },
  ...
  { id: 107, name: "Al-Ma'un", nameArabic: "الماعون", verses: 7, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Social"], usage: ["Daily"], openingStyle: "Commands", sajdah: false },
  ...
  { id: 109, name: "Al-Kafirun", nameArabic: "الكافرون", verses: 6, type: "Makkan", length: "Short", juz: 30, themes: ["Commands", "Tawheed"], usage: ["Daily"], openingStyle: "Commands", sajdah: false },
  ...
  { id: 112, name: "Al-Ikhlas", nameArabic: "الإخلاص", verses: 4, type: "Makkan", length: "Short", juz: 30, themes: ["Tawheed", "Commands"], usage: ["Daily", "Protection"], openingStyle: "Commands", sajdah: false },
  { id: 113, name: "Al-Falaq", nameArabic: "الفلق", verses: 5, type: "Makkan", length: "Short", juz: 30, themes: ["Protection", "Commands"], usage: ["Daily", "Protection"], openingStyle: "Commands", sajdah: false },
  { id: 114, name: "An-Nas", nameArabic: "الناس", verses: 6, type: "Makkan", length: "Short", juz: 30, themes: ["Protection", "Commands"], usage: ["Daily", "Protection"], openingStyle: "Commands", sajdah: false }
];